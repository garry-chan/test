...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body><div class="Header">			<div class="Navigation">
			...
			<!--(end Headings)-->
				...
				if ( isset($_POST['name']) )
				{
					...
					try
					{
						...
						echo '<article class="signupValid"><hgroup><h1>Thanks for signing up, '.htmlentities($_POST['name']).'!</h1></hgroup></article>';
					}
					catch(Exception $e)
					{
						echo '<article class="signupInvalid"><hgroup><h1>You did not complete the signup form correctly.</h1><h2>Please click the Back Button and enter a '.$e->getMessage().'.</h2></hgroup></article>';
					}
				}
				?>
		...
		if ( strpos($inventory,'Atlanta/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Atlanta/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Atlanta/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Chicago/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Chicago/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'London/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="London/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Los Angeles/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Los%20Angeles/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'New York/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="New%20York/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Ottawa/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Ottawa/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Paris/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Paris/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Stockholm/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Stockholm/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Tokyo/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Tokyo/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Toronto/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Toronto/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku01') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku01/"><img alt="[deal described in text]" src="/images/deal/deal01.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku02') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku02/"><img alt="[deal described in text]" src="/images/deal/deal02.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku03') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku03/"><img alt="[deal described in text]" src="/images/deal/deal03.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku04') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku04/"><img alt="[deal described in text]" src="/images/deal/deal04.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku05') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku05/"><img alt="[deal described in text]" src="/images/deal/deal05.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku06') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku06/"><img alt="[deal described in text]" src="/images/deal/deal06.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku07') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku07/"><img alt="[deal described in text]" src="/images/deal/deal07.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku08') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku08/"><img alt="[deal described in text]" src="/images/deal/deal08.jpg" /></a>';
	
		if ( strpos($inventory,'Washington/sku09') !== FALSE )
			echo '<a class="deal-image-anchor" href="Washington/sku09/"><img alt="[deal described in text]" src="/images/deal/deal09.jpg" /></a>';
		...
		<div class="SelfContained main market<?php 
